use prgc_idx::{Generation, IndexedVec};

use prgc_ast::decl::{Decl, DeclId, DeclKind, Path, PathNode};
use prgc_ast::expr::{Expr, ExprId, ExprKind, Stmt};
use prgc_ast::{Ast, NodeId};
